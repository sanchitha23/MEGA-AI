...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '94702722766' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '94702722766' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'DJIwCQKR#HghK0Td18iOF-jKEFOQxyhroicgRBHAfQmGN6_Zuv8k' ;  // put your session id here
